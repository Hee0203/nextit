...
public class PagingVO implements Serializable {
	...
	public void pageSetting() {
		...
		lastRow = firstRow + rowSizePerPage -1; // 10이 아닐 수도 있으니까 숫자로 쓰는 것은 지양한다
	...
	public int getRowSizePerPage() {return rowSizePerPage;}
	public void setRowSizePerPage(int rowSizePerPage) {this.rowSizePerPage = rowSizePerPage;}
