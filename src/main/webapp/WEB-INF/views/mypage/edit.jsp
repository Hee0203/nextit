				...
				<td>
					...
					<select name="memJob" class="form-control input-sm" >
						...
						<c:forEach items="${jobList }" var="job">
							<option value="${job.commCd }" ${member.memJob eq job.commCd ? "selected='selecte'" :""}>${job.commNm }</option>
						</c:forEach>		
					</select>			
				</td>
			</tr>
				...
				<td>
					...
					<select name="memHobby" class="form-control input-sm" >
						...
						<c:forEach items="${hobbyList }" var="hobby">
							<option value="${hobby.commCd }" ${member.memJob eq hobby.commCd ? "selected='selecte'" :""}>${hobby.commNm }</option>
						</c:forEach>	
